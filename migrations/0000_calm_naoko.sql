...
$$
    BEGIN
        ALTER TABLE "data"."sponsors_campaigns"
            ADD CONSTRAINT "sponsors_campaigns_company_companies_id_fk" FOREIGN KEY ("company") REFERENCES "data"."companies" ("id") ON DELETE no action ON UPDATE no action;
    EXCEPTION
        WHEN duplicate_object THEN null;
    END
$$;
...
$$
    BEGIN
        ALTER TABLE "data"."sponsors_spots"
            ADD CONSTRAINT "sponsors_spots_campaign_id_sponsors_campaigns_id_fk" FOREIGN KEY ("campaign_id") REFERENCES "data"."sponsors_campaigns" ("id") ON DELETE no action ON UPDATE no action;
    EXCEPTION
        WHEN duplicate_object THEN null;
    END
$$;
